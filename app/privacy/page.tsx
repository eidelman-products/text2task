  ...
  return (
    <main style={{ maxWidth: "800px", margin: "80px auto", lineHeight: "1.6", padding: "0 16px" }}>
      ...
      <p>
        ...
        to read basic email metadata such as sender and subject lines
        in order to identify unwanted emails.
      </p>

      <h2>No Email Storage</h2>
      <p>
        InboxShaper does not store, copy, or archive your emails.
        All processing happens in real-time through the Gmail API.
      </p>

      <h2>Actions Performed</h2>
      <p>
        Based on rules selected by the user, InboxShaper may move certain emails
