...
$safety_preamble$;
-- Source: supabase/migrations/202607270001_project_completion_reconciliation.sql (TRUNCATED -- see this file's own header and the generator's comment)
-- SHA-256 of the FULL, untruncated source file (normalized LF UTF-8): 8d22bc16c851ea7f53b2c4e7af92443317043df377bf48073b171e98a5dbed9a
-- Omitted tail: 1712 bytes starting with: -- One-time historical backfill.
-- ===== BEGIN 202607270001_project_completion_reconciliation.sql (verbatim through the omission point above) =====
...
-- ===== END 202607270001_project_completion_reconciliation.sql (truncated) =====
